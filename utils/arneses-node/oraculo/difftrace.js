...
var mode = args.indexOf("--golden") >= 0 ? "golden"
         ...
         : "check";
// Portado de la rama perf/stack-zone a main (4-sep-2026): sin frames/jit2; el modo a
// comparar ahora es la forma directa (--directo carga utils/spikes/directo, y mas
// adelante el codegen general via vm.jitDirecto).
var useDirecto = args.indexOf("--directo") >= 0;
